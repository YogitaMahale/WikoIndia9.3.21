...
namespace Autofocus.Controllers//CoreMoryatools.Areas.Admin.Controllers
{
   ...
   // [Authorize(Roles =SD.Role_Admin)]
    ...
    public class packingTypeController : Controller
    {
        ...
        public packingTypeController(IUnitofWork unitofWork, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult Create()
        {
            ...
            var model = new packingTypeCreateViewModel();
            return View(model);
        }
        ...
        public IActionResult Edit(int id)
        {
            ...
            var objcategory = _unitofWork.packingType.Get(id);
            if (objcategory == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(packingTypeCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var storeobj = _unitofWork.packingType.Get(model.id);
                if (storeobj == null)
                {
                ...
                _unitofWork.packingType .Update(storeobj);
                bool res = _unitofWork.Save();
        ...
        {
            var obj = _unitofWork.packingType.GetAll().Where(x=>x.isdeleted==false);
        ...
        {
            var obj = _unitofWork.packingType.Get(id);
            if(obj==null)
            {
            ...
            _unitofWork.packingType.Update(obj);
            bool res = _unitofWork.Save();
